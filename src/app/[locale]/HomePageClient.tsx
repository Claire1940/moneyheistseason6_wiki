...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://www.moneyheistseason6.wiki";
    ...
    "@graph": [
      {
        ...
        "@id": `${siteUrl}/#website`,
        url: siteUrl,
        name: "Money Heist Season 6 Wiki",
        description:
          "Track official Netflix status, release-date signals, cast updates, trailer checks, and where-to-watch details for Money Heist Season 6.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Money Heist Season 6 Wiki Hero Image",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Money Heist Season 6 Wiki",
        alternateName: "La Casa de Papel Season 6",
        url: siteUrl,
        description:
          "Fan resource hub for Money Heist Season 6 status, release tracking, cast updates, and trailer coverage.",
        logo: {
          "@type": "ImageObject",
        ...
        sameAs: [
          ...
          "https://www.reddit.com/r/LaCasaDePapel/",
          "https://www.instagram.com/lacasadepapel/",
          "https://x.com/lacasadepapel",
      ...
      },
      {
        "@type": "VideoGame",
        name: "Money Heist",
        gamePlatform: ["Netflix"],
        applicationCategory: "TVSeries",
      ...
      {
        "@type": "VideoObject",
        name: "Money Heist Part 5 Vol. 2 Teaser - Netflix",
        description:
          "Official Netflix teaser used as the primary trailer reference while Season 6 remains unconfirmed.",
        uploadDate: "2021-11-01",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/TFJwUwnShnA",
        url: "https://www.youtube.com/watch?v=TFJwUwnShnA",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://www.netflix.com/title/80192098"
                target="_blank"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://www.reddit.com/r/LaCasaDePapel/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)] text-sm hover:bg-[hsl(var(--nav-theme)/0.2)] transition-colors"
                  >
                    Netflix <ExternalLink className="w-3 h-3" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a
                    href="https://www.instagram.com/lacasadepapel/"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a
                    href="https://x.com/lacasadepapel"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
