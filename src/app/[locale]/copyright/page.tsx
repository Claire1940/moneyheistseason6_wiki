...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Money Heist Season 6 Wiki',
    description: 'Copyright and intellectual property information for Money Heist Season 6 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Money Heist Season 6 Wiki',
      description: 'Copyright and intellectual property information for Money Heist Season 6 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Money Heist Season 6 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Money Heist Season 6 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Money Heist Season 6 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Money Heist Season 6 Developers</strong> - Creators of the Money Heist Season 6 game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Money Heist Season 6</strong> - Trademark of the game developers</li>
              <li><strong>Money Heist Season 6 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Money Heist Season 6 Wiki.
            </p>
            ...
            <p>
              ...
              Money Heist Season 6 Wiki<br />
              Email: <a href="mailto:dmca@moneyheistseason6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@moneyheistseason6.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Money Heist Season 6 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Money Heist Season 6 Wiki (moneyheistseason6.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@moneyheistseason6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@moneyheistseason6.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@moneyheistseason6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@moneyheistseason6.wiki</a>
            </p>
            <p>
